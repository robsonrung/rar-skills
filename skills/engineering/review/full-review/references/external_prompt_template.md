...
<surrounding_context> {surrounding_code} </surrounding_context>
...
Return JSON: { "refuted": true | false, "rationale": "one to three sentences", "counter_evidence": ["short code indicator", "..."] } </task>

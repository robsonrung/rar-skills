...
Use the anchored rubric from `../doc-findings-schema.json` (the `confidence` field's behavioral criteria). Scope-guardian's domain grounds in the document's own stated goals and declared scope. Apply as:

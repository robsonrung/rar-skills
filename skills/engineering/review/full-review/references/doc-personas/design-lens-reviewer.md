...
Use the anchored rubric from `../doc-findings-schema.json` (the `confidence` field's behavioral criteria). Design-lens's domain grounds in named interaction states and user flows. Apply as:

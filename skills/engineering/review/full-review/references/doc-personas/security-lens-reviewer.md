...
Use the anchored rubric from `../doc-findings-schema.json` (the `confidence` field's behavioral criteria). Security-lens's domain grounds in named attack surfaces and missing mitigations. Apply as:

...
Use `shared/references/model-preview.md` before a direct invocation. The preview is the concrete plan selected for the run. Nested skills use that snapshot; they do not repeat selection or start unlisted workers. This workflow never invokes a council automatically.

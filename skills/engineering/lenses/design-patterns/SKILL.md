...
description: "Choose or review a Gang-of-Four pattern when recurring code structure creates a concrete design problem. Use to compare a named pattern with a simpler design; use architecture lenses for system boundaries."
---

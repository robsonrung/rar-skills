...
- Concrete model IDs are appropriate in the maintained roster, executable adapters, approved plans, receipts, and examples that test those contracts. Avoid duplicating them in general workflow prose.

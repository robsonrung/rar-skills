...
- To _find_ issues in a diff before or after resolving feedback, use `full-review` — it reviews, it never resolves threads.
...
_Adapted from compound-engineering-plugin's ce-resolve-pr-feedback — [compound-engineering-plugin](https://github.com/EveryInc/compound-engineering-plugin) (MIT). See NOTICE._

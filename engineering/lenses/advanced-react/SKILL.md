...
0. When invoked by `design-gate` or `implement-and-review`'s frontend track, run **review** mode against the plan or diff and return the gate contract above; weight the re-render lens higher when the detected UI library is styled-component-heavy (MUI is the common case).
...
- `references/composition.md` — the composition ladder (ch 1–4)
- `references/memo-recon.md` — keys, inner components, HOCs, memo as last resort (ch 5–7)
- `references/context-async.md` — context, refs, debounce, flicker, portals, fetch, errors (ch 8–16)
- `references/lenses.md` — the nine per-chapter review checklists
- `references/cheatsheet.md` — per-chapter decision tables and snippets

...
<grounding_rules> For each candidate finding in the handed-off findings directory:
...
- Dedupe: the same defect reported by two personas becomes one finding crediting the stronger version. </grounding_rules>

...
Judge any trend, pattern, or rule by: *does it reduce complexity here, or add it?*
...
| Getters and setters | Rare, when the field *is* the abstraction | A field wrapped in two shallow methods. Usually **classitis**. |

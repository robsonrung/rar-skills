...
The script (`scripts/validate-doc-claims.py`) reports flags; you decide each one. Three resolutions — **fix**, **annotate**, or **confirm intentional** — never an automatic rewrite and never an automatic pass:
...
## Step 2: Semantic validator subagent (Full mode; skipped in lightweight)

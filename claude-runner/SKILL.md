...
| `--model`, `-m` | Claude model alias or full model name such as `claude-sonnet-5` or `claude-opus-4-8` | CLI default |
...
python3 .agents/skills/claude-runner/scripts/run_claude.py "Compare two implementation plans" --model claude-sonnet-5

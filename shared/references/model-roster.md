...
| qwen | `pi-runner --seat qwen` → `pi` CLI (OpenRouter) | — | `qwen/qwen3.8-max` | Council seat (optional tier). Qwen3.8 Max — the dense open-weight VLM of the Qwen3.8 Max family, 256K context; coding- and long-horizon-agentic-strong (SWE-bench Pro 61.7, CoWorkBench 70.7). Served via OpenRouter (`OPENROUTER_API_KEY`). |

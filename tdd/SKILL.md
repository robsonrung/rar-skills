...
2. **Write the test first, predict the failure, see it fail.** Express *what* the code should do from its caller's perspective. Say the expected failure out loud before running — a different failure already taught you something.
